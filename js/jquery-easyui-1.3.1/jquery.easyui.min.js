...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"输入不能为空.",invalidMessage:null,rules:{email:{validator:function(_39c){
...
},message:"请输入有效的电子邮件地址."},url:{validator:function(_39d){
...
},message:"请输入有效的URL."},length:{validator:function(_39e,_39f){
